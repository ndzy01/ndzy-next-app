...
const components = {
  ...
  h3: (props: React.ComponentPropsWithoutRef<'h3'>) => <h3 className="text-2xl font-medium mt-4 mb-2" {...props} />,
  h4: (props: React.ComponentPropsWithoutRef<'h4'>) => <h4 className="text-xl font-medium mt-3 mb-2" {...props} />,
  ...
  hr: (props: React.ComponentPropsWithoutRef<'hr'>) => <hr className="my-8 border-gray-300 dark:border-gray-700" {...props} />,
};
